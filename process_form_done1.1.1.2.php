...
if ($result->num_rows > 0) {
    ...
    <th style='padding: 10px; border: 1px solid #dddddd; text-align: center; white-space: nowrap;'>검토결과</th>
    <th style='padding: 10px; border: 1px solid #dddddd; text-align: center; white-space: nowrap;'>결과통보일자</th>
    <th style='padding: 10px; border: 1px solid #dddddd; text-align: center; white-space: nowrap;'>수수료요청</th>
    <th style='padding: 10px; border: 1px solid #dddddd; text-align: center; white-space: nowrap;'>공급가액</th>
    <th style='padding: 10px; border: 1px solid #dddddd; text-align: center; white-space: nowrap;'>부가세</th>
    <th style='padding: 10px; border: 1px solid #dddddd; text-align: center; white-space: nowrap;'>공급대가</th>
    </tr>";
    ...
    while($row = $result->fetch_assoc()) {
      echo "<tr>";
        ...
        echo "<td style='padding: 10px; border: 1px solid #dddddd; white-space: nowrap;'>" . $row['검토결과'] . "</td>";
        echo "<td style='padding: 10px; border: 1px solid #dddddd; white-space: nowrap;'>" . $row['결과통보일자'] . "</td>";
        echo "<td style='padding: 10px; border: 1px solid #dddddd; white-space: nowrap;'>" . $row['수수료요청'] . "</td>";
        echo "<td style='padding: 10px; border: 1px solid #dddddd; white-space: nowrap;'>" . $row['공급가액'] . "</td>";
        echo "<td style='padding: 10px; border: 1px solid #dddddd; white-space: nowrap;'>" . $row['부가세'] . "</td>";
        echo "<td style='padding: 10px; border: 1px solid #dddddd; white-space: nowrap;'>" . $row['공급대가'] . "</td>";
        echo "</tr>";
    }
    echo "</table>";
} else {
